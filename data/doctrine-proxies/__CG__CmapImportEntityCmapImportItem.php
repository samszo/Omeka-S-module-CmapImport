...
namespace DoctrineProxies\__CG__\CmapImport\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class CmapImportItem extends \CmapImport\Entity\CmapImportItem implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'import', 'item', 'action'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CmapImportItem $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setImport(\CmapImport\Entity\CmapImport $import)
    {
